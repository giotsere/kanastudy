...
function KanaExplanation() {
  return (
    <div>
      ...
      <div className="text-xl w-4/5 m-auto">
        ...
        <div className="flex mb-6 justify-center">
          ...
          <div className="w-4 h-4 bg-teal-500 m-2 ml-4"></div>
          <p>Kanji</p>
          <div className="w-4 h-4 bg-amber-300 m-2 ml-4"></div>
          <p>Hiragana</p>
          <div className="w-4 h-4 bg-pink-500 m-2 ml-4"></div>
          <p>Katakana</p>
        </div>
